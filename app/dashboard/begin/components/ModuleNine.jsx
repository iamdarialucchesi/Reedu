...
import moduleNineHeadImage from "@/public/images/old-lady-picture.png";
import clickToStart from "@/public/icons/click-to-start-btn.svg";
import bookHolderPicture from "@/public/images/book-holder-picture.png";
...
export default function ModuleNine() {
    ...
    return (
        <div className={`${isExpanded ? "mb-15" : "mb-10"}`}>
            <ModuleHead src={moduleNineHeadImage} onClick={toggleExpand}>
                <div className="py-1">
                    <p className="mb-2 text-darkLow fw-bold fs-18">Module Nine : You have Achieved your Goal</p>
            ...
            <div className="position-relative" style={{top: isExpanded ? "70px" : "0px"}}>
                ...
                <div className="d-flex justify-content-center position-relative">
                    <Image src={clickToStart} alt="click-to-start" height={90} width={90}
                           className={`${count >= 9 && "cursor-pointer"}`}
                           onClick={handleNavigate}/>
                    <div
                        className="chat-bubble chat-bubble-module-two px-3 py-2 bg-whiteLow position-absolute d-none d-lg-block">
                        <p className="text-darkerGrey fw-normal fs-16 m-0">Let’s Celebrate and Planning for Next
                            Steps</p>
                    </div>
                    <Image src={bookHolderPicture} alt="girl-gif" width={60} height={100} unoptimized={true}
