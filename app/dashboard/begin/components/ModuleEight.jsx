...
import moduleEightHeadImage from "@/public/images/old-lady-picture.png";
import clickToStart from "@/public/icons/click-to-start-btn.svg";
import degreeHolderBoyPicture from "@/public/images/module-one-small.png";
...
export default function ModuleEight() {
    ...
    return (
        <div className={`${isExpanded ? "mb-15" : "mb-10"}`}>
            <ModuleHead src={moduleEightHeadImage} onClick={toggleExpand}>
                <div className="py-1">
                    <p className="mb-2 text-darkLow fw-bold fs-18">Module Eight : Owning a Home</p>
            ...
            <div className="position-relative" style={{top: isExpanded ? "70px" : "0px"}}>
                ...
                <div className="d-flex justify-content-center position-relative">
                    <Image src={clickToStart} alt="click-to-start" height={90} width={90}
                           className={`${count >= 8 && "cursor-pointer"}`}
                           onClick={handleNavigate}/>
                    <div
                        className="chat-bubble-six chat-bubble-module-two px-3 py-2 bg-whiteLow position-absolute d-none d-lg-block">
                        <p className="text-darkerGrey fw-normal fs-16 m-0">Owning A Home</p>
                    </div>
                    <Image src={degreeHolderBoyPicture} alt="girl-gif" width={70} height={100} unoptimized={true}
